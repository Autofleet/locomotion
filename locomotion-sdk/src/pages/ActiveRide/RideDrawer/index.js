          ...
          ? (
            <Fragment>
              <RideStatusHeader
                ...
                arrivingPush={activeRide.arrivingPush}
              />

              {rideState && (pickupEta <= useSettings.settingsList.ARRIVE_REMINDER_MIN || activeRide.arrivingPush !== null || rideState !== 'driverOnTheWay')
                ? (
                  <Fragment>

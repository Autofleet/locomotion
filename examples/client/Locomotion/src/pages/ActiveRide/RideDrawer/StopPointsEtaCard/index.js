...
export default ({
  ...
  const firstEta = rideState
    ? origin && origin.metadata && origin.metadata.firstEta
    : undefined;
        ...
        description={
          rideState
            ...
            : requestStopPoints &&
              ...
              requestStopPoints.pickup.description
        }
        ...
        description={
          rideState
            ...
            : requestStopPoints &&
              ...
              requestStopPoints.dropoff.description
        }
        ...
        firstEta={
          rideState
            ? destination &&
              ...
              destination.metadata.firstEta
            : undefined
        }
        completedAt={
          rideState ? destination && destination.completedAt : undefined
        }

...
export default ({closeAfter, onClose, rideSummaryData, onRating}) => {
  ...
  const Star = props => {
    ...
    return (
      <Button noBg {...props} data-test-id="RattingButton">
        <StarIcon source={source} isOn={props.isOn} />
      </Button>
    );
  };
  ...
  return (
    <Modal isVisible={isPopupOpen('rideSummary') || false}>
      <SummaryContainer>
        <CloseContainer
          onPress={() => closePopup()}
          data-test-id="CloseRideSummaryPopup">
          <ResetInputIcon />
        </CloseContainer>
        <View style={{flex: 2, textAlign: 'left', maxWidth: '80%'}}>
          <SummaryTitle>
            {i18n.t('popups.rideSummary.thanksForRideHeadline')}
          </SummaryTitle>
          <SummarySubTitle>
            {i18n.t('popups.rideSummary.rideDataHeadline')}
          </SummarySubTitle>
          ...
          <SummaryItems>
            <SummaryItem>
              ...
              <SummaryItemTitle>
                {i18n.t('popups.rideSummary.durationLabel')}
              </SummaryItemTitle>
              <SummaryItemText>
                {i18n.t('popups.rideSummary.durationValue', {
                  duration: rideSummaryData.duration,
                })}
              </SummaryItemText>
            </SummaryItem>
            ...
            <SummaryItem last={!rideSummaryData.price}>
              ...
              <SummaryItemTitle>
                {i18n.t('popups.rideSummary.distanceLabel')}
              </SummaryItemTitle>
              <SummaryItemText>
                {i18n.t('popups.rideSummary.distanceValue', {
                  distance: (rideSummaryData.distance / 1000).toFixed(1),
                })}
              </SummaryItemText>
            </SummaryItem>
            ...
            {rideSummaryData.price !== null ? (
              <SummaryItem last>
                ...
                <SummaryItemTitle>
                  {i18n.t('popups.rideSummary.priceLabel')}
                </SummaryItemTitle>
                <SummaryItemText>
                  {i18n.t('popups.rideSummary.priceValue', {
                    price: rideSummaryData.price,
                  })}
                </SummaryItemText>
              </SummaryItem>
            ) : null}
          ...
          <SummaryStarsSubTitle>
            {i18n.t('popups.rideSummary.ratingPre')}
          </SummaryStarsSubTitle>
          <SummaryStarsTitle>
            {i18n.t('popups.rideSummary.ratingHeadline')}
          </SummaryStarsTitle>
          <StarRating />
          <RoundedButton
          ...
          {ratingSent ? (
            <SummaryStarsSubTitle>
              {i18n.t('popups.rideSummary.ratingPost')}
            </SummaryStarsSubTitle>
          ) : null}
        </View>
      </SummaryContainer>
